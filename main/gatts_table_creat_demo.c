...
#define SAMPLE_DEVICE_NAME "fun=fantasyuniverse"
...
static const char hlth_value[] = "HEALTH: H H H";
static const char old1_value[] = "flag:bit.ly/2LOGYtf";
static const char old2_value[] = "Old Gent 2";
static const char old3_value[] = "Old Gent 3";
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
    {
        ...
        [IDX_CHAR_NAME] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_declaration_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE, (uint8_t *)&char_prop_read_write}},

        /* NAME Characteristic Value */
        [IDX_CHAR_VAL_NAME] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_NAME, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(name_value) - 1, (uint8_t *)name_value}},
        ...
        [IDX_CHAR_VAL_HLTH] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_HLTH, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(hlth_value) - 1, (uint8_t *)hlth_value}},

        //////	OLD GENTS + BARTENDER	//////
        /* OLD1 Characteristic Declaration */
        [IDX_CHAR_OLD1] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_declaration_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE, (uint8_t *)&char_prop_read}},

        /* OLD1 Characteristic Value */
        [IDX_CHAR_VAL_OLD1] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_OLD1, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(old1_value) - 1, (uint8_t *)old1_value}},
        ...
        [IDX_CHAR_VAL_OLD2] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_OLD2, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(old2_value) - 1, (uint8_t *)old2_value}},

        /* Client Characteristic Configuration Descriptor */
        [IDX_CHAR_CFG_OLD2] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, sizeof(uint16_t), sizeof(old2_value) - 1, (uint8_t *)old2_value}},

        /* indicate flag Characteristic Declaration */
        [IDX_CHAR_OLD3] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_declaration_uuid, ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE, (uint8_t *)&char_prop_read_write_indicate}},

        /* Characteristic Value */
        [IDX_CHAR_VAL_OLD3] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_OLD3, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(old3_value), (uint8_t *)old3_value}},

        /* Client Characteristic Configuration Descriptor */
        [IDX_CHAR_CFG_OLD3] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, sizeof(uint16_t), sizeof(old3_value) - 1, (uint8_t *)old3_value}},
        ...
        /* Characteristic Value */
        [IDX_CHAR_VAL_BART] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_BART, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(bart_value) - 1, (uint8_t *)bart_value}},

        /* Client Characteristic Configuration Descriptor */
        [IDX_CHAR_CFG_BART] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, sizeof(uint16_t), sizeof(bart_value) - 1, (uint8_t *)bart_value}},
        ...
        /* Characteristic Value */
        [IDX_CHAR_VAL_POMM] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_POMM, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(pomm_value) - 1, (uint8_t *)pomm_value}},

        /* Client Characteristic Configuration Descriptor */
        [IDX_CHAR_CFG_POMM] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, sizeof(uint16_t), sizeof(pomm_value) - 1, (uint8_t *)pomm_value}},
        ...
        /* Characteristic Value */
        [IDX_CHAR_VAL_HILT] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_HILT, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(hilt_value) - 1, (uint8_t *)hilt_value}},

        /* Client Characteristic Configuration Descriptor */
        [IDX_CHAR_CFG_HILT] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, sizeof(uint16_t), sizeof(hilt_value) - 1, (uint8_t *)hilt_value}},
        ...
        /* Characteristic Value */
        [IDX_CHAR_VAL_BLAD] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_BLAD, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(blad_value) - 1, (uint8_t *)blad_value}},

        /* Client Characteristic Configuration Descriptor */
        [IDX_CHAR_CFG_BLAD] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, sizeof(uint16_t), sizeof(blad_value) - 1, (uint8_t *)blad_value}},
        ...
        /* Characteristic Value */
        [IDX_CHAR_VAL_SCAB] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_SCAB, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(scab_value) - 1, (uint8_t *)scab_value}},

        /* Client Characteristic Configuration Descriptor */
        [IDX_CHAR_CFG_SCAB] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, sizeof(uint16_t), sizeof(scab_value) - 1, (uint8_t *)scab_value}},
        ...
        /* Characteristic Value */
        [IDX_CHAR_VAL_CROS] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_CROS, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(cros_value) - 1, (uint8_t *)cros_value}},

        /* Client Characteristic Configuration Descriptor */
        [IDX_CHAR_CFG_CROS] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, sizeof(uint16_t), sizeof(cros_value) - 1, (uint8_t *)cros_value}},
        ...
        /* Characteristic Value */
        [IDX_CHAR_VAL_BLKS] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_BLKS, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(blks_value) - 1, (uint8_t *)blks_value}},

        /* Client Characteristic Configuration Descriptor */
        [IDX_CHAR_CFG_BLKS] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, sizeof(uint16_t), sizeof(blks_value) - 1, (uint8_t *)blks_value}},
        ...
        /* Characteristic Value */
        [IDX_CHAR_VAL_TROL] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_TROL, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(trol_value) - 1, (uint8_t *)trol_value}},

        /* Client Characteristic Configuration Descriptor */
        [IDX_CHAR_CFG_TROL] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, sizeof(uint16_t), sizeof(trol_value) - 1, (uint8_t *)trol_value}},
        ...
        /* Characteristic Value */
        [IDX_CHAR_VAL_TERR] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_TERR, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(terr_value) - 1, (uint8_t *)terr_value}},

        /* Client Characteristic Configuration Descriptor */
        [IDX_CHAR_CFG_TERR] =
            {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, sizeof(uint16_t), sizeof(terr_value) - 1, (uint8_t *)terr_value}},
...
static void gatts_profile_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    ...
    case ESP_GATTS_WRITE_EVT:
        ...
        if (!param->write.is_prep)
        {
            ...
            {
                esp_ble_gatts_set_attr_value(blectf_handle_table[IDX_CHAR_NAME] + 1, 20, (uint8_t *)"thisisaflag4yurname");
            }

            //////  Old Gents   //////
            //TODO: make how you hear from them different-write then read, write notify, write indicate
            // old2
            if (blectf_handle_table[IDX_CHAR_OLD2] + 1 == param->write.handle)
            {
                char notify_data[20] = "flag::bit.ly/2v3Qlhq";
            ...
            {
                char indicate_data[20] = "flag::bit.ly/2NLcVmC";
                esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, blectf_handle_table[IDX_CHAR_VAL_OLD3], sizeof(indicate_data), (uint8_t *)indicate_data, true);
               }

            // bart   
            if (blectf_handle_table[IDX_CHAR_BART] + 1 == param->write.handle && strcmp(writeData,"Where 2 get a sword")==0)
            {
                char notify_data[20] = "Gather 5 pieces of ";
                char notify_data1[20] = "a sword from the cem";
                char notify_data2[18] = "etary.The flag is";
                char notify_data3[20] = "goget5piecesofasword";
                ...
                esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, blectf_handle_table[IDX_CHAR_BART], sizeof(notify_data1), (uint8_t *)notify_data1, false);
                esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, blectf_handle_table[IDX_CHAR_BART], sizeof(notify_data2), (uint8_t *)notify_data2, false);
                esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, blectf_handle_table[IDX_CHAR_BART], sizeof(notify_data3), (uint8_t *)notify_data3, false);
            }
            ...
            if (blectf_handle_table[IDX_CHAR_BLKS] + 1 == param->write.handle)
            {
                ...
                { // else tells them to order keys from bottom to top and last is scabbard
                    esp_ble_gatts_set_attr_value(blectf_handle_table[IDX_CHAR_BLKS] + 1, sizeof(blks_value) - 1, (uint8_t *)blks_value);
            ...
            // Terrain/Goblins
            // buffer overflow...well kinda...if you don't look at code it seems like one
